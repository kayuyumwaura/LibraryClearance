...
namespace LibraryClearance.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtherUserCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClearancePurpose = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OtherClearancePurpose = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UseOfContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OtherUseOfContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Duration = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OtherDuration = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClearanceRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClearanceRequests_UserId",
